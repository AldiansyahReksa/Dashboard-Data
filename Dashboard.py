...
# File paths
file_path_laut = 'kunjungan_wisata_mancanegara_laut.xlsx'
file_path_darat = 'kunjungan_wisata_mancanegara_darat.xlsx'
file_path_udara = 'kunjungan_wisata_mancanegara_udara.xlsx'
