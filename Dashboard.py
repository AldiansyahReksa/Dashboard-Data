...
# menyiapkan side bar
st.title("Dashboard Data created by : Kelompok 3 ")
with st.sidebar:
    
#Sidebar dengan informasi anggota kelompok
    st.title("Dashboard Data created by : Kelompok 3")
    st.write("Nama: **Aldiansyah Reksa Pratama Wicaksono**, Nrp: 220434015")
    st.write("Nama: **Almayda Faturrohman**, Nrp: 210414009")
    st.write("Nama: **Muhammad Fakhrijal Pratama**, Nrp: 210414017")
    st.write("Nama: **Rifky Azis Maulana Yusuf**, Nrp:  210414018")
    st.write("Nama: **Melly Diyani**, Nrp: 210414028")
    
    # Menambahkan logo perusahaan
    st.image("raspberry.png")
...
st.header('LATIHAN Collection Dashboard :sparkles:')
...
#  demografi pelanggan yang kita miliki.
