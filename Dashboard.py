...
#Sidebar dengan informasi anggota kelompok
    st.title("Dashboard Data created by : Kelompok 3")
    st.write("Nama: **Aldiansyah Reksa Pratama**, Nrp: 220434015")
    st.write("Nama: **Almayda Faturohman**, Nrp: 220434015")
    st.write("Nama: **M.Fakhrijal Pratama**, Nrp: 220434015")
    st.write("Nama: **Rifky Azis**, Nrp: 220434015")
    st.write("Nama: **Melly Diyani**, Nrp: 220434015")
